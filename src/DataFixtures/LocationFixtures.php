...
{
    private static array $countyExternalIds = [
        'Budapest' => 1,
        'Pest' => 2,
        'Fejér' => 3,
        'Komárom-Esztergom' => 4,
    ...
    private static array $constituencyExternalIds = [
        'Bács-Kiskun 1.' => '1801',
        'Bács-Kiskun 2.' => '1802',
        'Bács-Kiskun 3.' => '1803',
        'Bács-Kiskun 4.' => '1804',
        ...
        'Békés 3.' => '1903',
        'Békés 4.' => '1904',
        'Borsod-Abaúj-Zemplén 1.' => '1201',
        'Borsod-Abaúj-Zemplén 2.' => '1202',
        'Borsod-Abaúj-Zemplén 3.' => '1203',
        'Borsod-Abaúj-Zemplén 4.' => '1204',
        'Borsod-Abaúj-Zemplén 5.' => '1205',
        'Borsod-Abaúj-Zemplén 6.' => '1206',
        'Borsod-Abaúj-Zemplén 7.' => '1207',
        'Budapest 01.' => '0101',
        'Budapest 02.' => '0102',
        'Budapest 03.' => '0103',
        'Budapest 04.' => '0104',
        ...
        'Budapest 17.' => '0117',
        'Budapest 18.' => '0118',
        'Csongrád-Csanád 1.' => '2001',
        'Csongrád-Csanád 2.' => '2002',
        'Csongrád-Csanád 3.' => '2003',
        'Csongrád-Csanád 4.' => '2004',
        'Fejér 1.' => '0301',
        'Fejér 2.' => '0302',
        'Fejér 3.' => '0303',
        'Fejér 4.' => '0304',
        'Fejér 5.' => '0305',
        'Győr-Moson-Sopron 1.' => '0601',
        'Győr-Moson-Sopron 2.' => '0602',
        'Győr-Moson-Sopron 3.' => '0603',
        'Győr-Moson-Sopron 4.' => '0604',
        'Győr-Moson-Sopron 5.' => '0605',
        'Hajdú-Bihar 1.' => '1501',
        'Hajdú-Bihar 2.' => '1502',
        'Hajdú-Bihar 3.' => '1503',
        'Hajdú-Bihar 4.' => '1504',
        ...
        'Heves 2.' => '1302',
        'Heves 3.' => '1303',
        'Jász-Nagykun-Szolnok 1.' => '1601',
        'Jász-Nagykun-Szolnok 2.' => '1602',
        'Jász-Nagykun-Szolnok 3.' => '1603',
        'Jász-Nagykun-Szolnok 4.' => '1604',
        'Komárom-Esztergom 1.' => '0401',
        'Komárom-Esztergom 2.' => '0402',
        'Komárom-Esztergom 3.' => '0403',
        'Nógrád 1.' => '1401',
        'Nógrád 2.' => '1402',
        'Pest 01.' => '0201',
        'Pest 02.' => '0202',
        ...
        'Somogy 3.' => '1003',
        'Somogy 4.' => '1004',
        'Szabolcs-Szatmár-Bereg 1.' => '1701',
        'Szabolcs-Szatmár-Bereg 2.' => '1702',
        'Szabolcs-Szatmár-Bereg 3.' => '1703',
        'Szabolcs-Szatmár-Bereg 4.' => '1704',
        'Szabolcs-Szatmár-Bereg 5.' => '1705',
        'Szabolcs-Szatmár-Bereg 6.' => '1706',
        'Tolna 1.' => '1101',
        'Tolna 2.' => '1102',
        'Tolna 3.' => '1103',
        'Vas 1.' => '0701',
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($this->getData() as $countyName => $settlements) {
            $county = (new County())
                ->setName($countyName)
                ->setExternalId(self::$countyExternalIds[$countyName] ?? null);
            $manager->persist($county);

            foreach ($settlements as $settlementName => $settlementData) {
                $settlement = (new Settlement())
                    ->setCounty($county)
                    ->setName($settlementName)
                    ->setLatitude($settlementData['coordinates']['lat'])
                    ->setLongitude($settlementData['coordinates']['lng']);
                $manager->persist($settlement);

                foreach ($settlementData['constituencies'] as $constituencyName) {
                    if (!array_key_exists($constituencyName, $constituencyCache)) {
                        $constituency = (new Constituency())
                                ->setName($constituencyName)
                                ->setExternalId(self::$constituencyExternalIds[$constituencyName] ?? '');
                        $manager->persist($constituency);

                        $constituencyCache[$constituencyName] = $constituency;
                    }

                    $settlement->addConstituency($constituencyCache[$constituencyName]);
                    $constituencyCache[$constituencyName]->addSettlement($settlement);
                }
            }
        }
        ...
        $county = (new County())
            ->setName('Külföld')
            ->setSystemName(County::ABROAD);
        $manager->persist($county);

        $county = (new County())
            ->setName('Több megyét érint')
            ->setSystemName(County::MULTIPLE);
        $manager->persist($county);
